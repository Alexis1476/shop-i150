...
INSERT INTO `t_product` (`idProduct`,
                         ...
                         `proLike`,
                         `fkCategory`)
VALUES (1, 'Pullover', 'Pullover synthétique', 20.9, 10, 'pull.png', 0, 1),
       ...
       (4, 'Disque dur externe',
        'Disque dur externe de 1 To, idéal pour stocker et sauvegarder vos données de manière sécurisée.', 79.95, 2,
        'harddisk.png', 0, 3),
...
VALUES (1,
        ...
        'admin'),
       (2, 'customer', '$2y$10$.8sXz4/qH5sngNgdEnn8HesHO3qoDvUcYmslZyGIpCUz1He0OmOAS',
        'customer');
...
create unique index ID_t_order_IND on t_order (idOrder);
